...
highFrequency // Run every frame until it's disabled.
{
   ...
   bool hasBothFactories = false;
   int factoryCount = 0;
   bool hasIndustrialFort = false;
   ...
   switch (pass)
   {
              ...
              // We later build a deck based on these priorities.
      {
         if (numCardsProcessed == 0) // First run.
         {
            ...
            {
			   int enhancedDeckExists = -1;
               if (gHaveWaterSpawnFlag == true)
               {
                  premadeDeckID = aiHCPreMadeDeckGetIndex("Enhanced-Naval");
               }
               else 
               {
                  premadeDeckID = aiHCPreMadeDeckGetIndex("Enhanced-Land");
               }
         ...
         for (i = startingCardIndex; < totalCardCount) // Loop through each card.
         {
            ...
            if (civIsRevolution() == true)
            {
               ...
               exclude = ((tech == cTechHCShipBalloons) || (tech == cTechHCMedicine) ||
                  (tech == cTechHCStockyards) || (tech == cTechHCNativeTreaties) ||
                  (tech == cTechHCMercenaryLoyalty) || (tech == cTechHCSilversmith) ||
            ...
            {               
               case cCivBritish:
               {
                  exclude = (//(tech == cTechHCXPFlorenceNightingale) || 
                     (tech == cTechHCStockyards) || (tech == cTechHCMedicine) ||
                     (tech == cTechHCFullingMills) || (tech == cTechHCXPSouthSeaBubble) ||
                     (tech == cTechHCExplorerBritish) || (tech == cTechDEHCTheaters) ||
                     (tech == cTechHCNativeTreaties) || (tech == cTechDEHCRangers) || // We can get these at the church...
                     (tech == cTechHCXPAgents) || (tech == cTechDEHCSiegeArchery) || // We want rangers, so we don't need this...
                     (tech == cTechHCHouseEstates) || (tech == cTechHCShipSettlers2) ||
                     (tech == cTechHCNativeWarriors) || (tech == cTechHCAdvancedArtillery) ||
                     (tech == cTechHCHeavyFortifications) || (tech == cTechHCSilversmith) ||
                     (tech == cTechHCSpiceTrade) || (tech == cTechHCFastHousesTeam) ||
                     (tech == cTechHCXPRanching) || (tech == cTechHCMercenaryLoyalty) ||
                     (tech == cTechHCAdvancedTradingPost) || (tech == cTechHCAdmirality && gWaterMap == false) ||
                     (((tech == cTechHCShipFalconets2) || (tech == cTechHCShipMortars2) || (tech == cTechHCXPShipGrenadiersRepeat) ||
                     (tech == cTechHCShipMortars1) || (tech == cTechHCShipLongbowmen1) || (tech == cTechHCShipMusketeers1) || 
                     (tech == cTechHCXPShipRocketsRepeat)) && (startingResources != cGameStartingResourcesInfinite)));
                  break;
               }
               case cCivDutch:
               {
                  exclude = ((tech == cTechHCXPMasterSurgeons) || (tech == cTechHCExplorerDutch) ||
                     ...
                     (tech == cTechHCNativeTreaties) || (tech == cTechDEHCSeventeenProvinces) ||
                     (tech == cTechHCXPAgents) || (tech == cTechHCNativeWarriors) || (tech == cTechHCCheapMarketsTeam) ||
                     (tech == cTechDEHCFlemishRevolution) || (tech == cTechDEHCBelgianRevolution) ||
                     (tech == cTechDEHCTheaters) || (tech == cTechHCAdvancedArtillery) || (tech == cTechHCShipEnvoyTeam) ||
                     (tech == cTechHCHeavyFortifications) || (tech == cTechHCFrontierDefenses2) ||
                     (tech == cTechHCAdvancedPlantations) || (tech == cTechHCShipCulverins1) || (tech == cTechHCXPShipMortarsTeam) ||
                     (tech == cTechDEHCMercenaryArmyDutch) || (tech == cTechHCMercenaryLoyalty) || 
                     (tech == cTechHCSilversmith) || (tech == cTechHCSpiceTrade) || (tech == cTechHCMedicine) ||
                     (tech == cTechHCAdvancedTradingPost) || (tech == cTechHCSpiceTradeTeam) ||
                     (tech == cTechHCAdmirality && gWaterMap == false));
                  break;
               }
               case cCivFrench:
               {
                  exclude = ((tech == cTechHCXPMasterSurgeons) || (tech == cTechHCNorthwestPassage) ||
                     ...
                     (tech == cTechHCNativeTreaties) || (tech == cTechHCAdvancedArtillery) ||
                     (tech == cTechDEHCTheaters) || (tech == cTechHCSawmillsTeam) || (tech == cTechHCMedicine) ||
                     (tech == cTechHCXPTirailleurs) || (tech == cTechHCXPAssassins) ||
                     (tech == cTechHCHeavyFortifications) || (tech == cTechHCEarlySkirmishersTeam) ||
                     (tech == cTechDEHCShipBalloonsFrench) || (tech == cTechHCShipPikemen3) ||
                     (tech == cTechHCShipCrossbowmen3) || (tech == cTechHCNativeWarriors) ||
                     (tech == cTechHCMercenaryLoyalty) || (tech == cTechHCSilversmith) || (tech == cTechHCSpiceTrade) ||
                     (tech == cTechHCAdvancedTradingPost) || (tech == cTechHCXPBloodBrothers) ||
                     (tech == cTechDEHCCentSuisses) || (tech == cTechHCCheapChurchTeam) ||
                     (tech == cTechHCAdmirality && gWaterMap == false) || (((tech == cTechHCShipMortars2) || 
                     (tech == cTechHCXPShipCuirassiersRepeat) || (tech == cTechHCShipMortars1) ||
                     (tech == cTechHCShipFalconets2)) && (startingResources != cGameStartingResourcesInfinite))); // (tech == cTechDEHCQuiche)
                  break;
               }
               case cCivGermans:
               {
                  exclude = ((tech == cTechHCXPMasterSurgeons) || (tech == cTechHCExplorerGerman) ||
                     ...
                     (tech == cTechHCXPAgents) || (tech == cTechDEHCMarchRevolution) || (tech == cTechHCXPShipMortarsTeam) ||
                     (tech == cTechDEHCTheaters) || (tech == cTechHCShipMortars1German) || (tech == cTechHCShipMortars2German) ||
                     ...
                     (tech == cTechHCSilversmithGerman) || (tech == cTechHCSpiceTradeGerman) ||
                     (tech == cTechHCAdvancedTradingPost) || (tech == cTechHCPalatineSettlements) ||
                     (tech == cTechHCConestogaWagonsTeam) || (tech == cTechHCTeamTeutonTownCenter) || (((tech == cTechHCShipMortars2German) || 
                     (tech == cTechHCShipCulverins1German) || (tech == cTechHCShipMortars1German) || 
                     (tech == cTechHCShipFalconets2German) || (tech == cTechHCXPShipCannonsRepeat)) && 
               ...
               case cCivOttomans:
               {
                  exclude = ((tech == cTechHCXPMasterSurgeons) || (tech == cTechHCExplorerOttoman) ||
                     (tech == cTechHCShipBalloons) || (tech == cTechHCXPRanching) || (tech == cTechHCMedicine) ||
                     (tech == cTechHCXPSublimePorte) || (tech == cTechHCStockyards) ||
                     (tech == cTechHCNativeTreaties) || (tech == cTechHCBattlefieldConstruction) ||
                     (tech == cTechDEHCTheaters) || (tech == cTechHCNativeWarriors) ||
                     (tech == cTechDEHCShipHumbaracisRepeat) || (tech == cTechHCXPShipMortarsTeam) ||
                     (tech == cTechHCTeamCoinCrates2) || (tech == cTechHCShipFalconets2) ||
                     (tech == cTechHCSpiceTrade) || (tech == cTechHCSilversmith) || (tech == cTechHCShipSpahisTeam) ||
                     (tech == cTechHCCheapTradingPostTeam) || (tech == cTechHCIronmongerTeam) ||
                     (tech == cTechDEHCYildizAgents) || (tech == cTechDEHCShipSpies1Ottoman) ||
                     (tech == cTechHCFrontierDefenses2) || (tech == cTechHCMosqueConstruction) ||
                     (tech == cTechHCBastionsTeam) || (tech == cTechHCMercenaryLoyalty) ||
                     (tech == cTechHCTeamCoinCrates1) || (tech == cTechHCSilversmith) || (tech == cTechHCSpiceTrade) ||
					      (tech == cTechDEHCShipSpies2Ottoman) || (tech == cTechHCAdvancedTradingPost) ||
                     (tech == cTechHCAdmirality && gWaterMap == false) || (tech == cTechHCRenderingPlant) || 
                     (((tech == cTechDEHCShipJanissariesRepeat) ||
                     (tech == cTechDEHCShipHumbaracisRepeat) || (tech == cTechHCShipMortars2) || 
                     (tech == cTechHCShipMortars1) || (tech == cTechHCShipFalconets2)) &&
                     (startingResources != cGameStartingResourcesInfinite)));
                  break;
               }
               case cCivPortuguese:
               {
                  exclude = ((tech == cTechHCXPMasterSurgeons) || (tech == cTechHCExplorerPortuguese) ||
                     ...
                     (tech == cTechHCRidingSchool) || (tech == cTechHCMedicine) ||
                     ...
                     (tech == cTechHCImprovedWallsTeam) ||
                     (tech == cTechHCXPAgents) ||
                     (tech == cTechHCEngineeringSchool) ||
                     (tech == cTechDEHCTheaters) || (tech == cTechHCDonatarios) ||
                     (tech == cTechHCSpawnFishingBoats) || (tech == cTechHCHeavyFortifications) ||
                     (tech == cTechHCAdvancedArtillery) || (tech == cTechHCXPBloodBrothers) ||
                     (tech == cTechHCXPShipHorseArtillery2) ||
                     (tech == cTechDEHCNavalInfantry) || (tech == cTechHCMercenaryLoyalty) ||
                     (tech == cTechHCSilversmith) || (tech == cTechHCSpiceTrade) ||
                     (tech == cTechHCAdvancedTradingPost) || (tech == cTechHCAdmirality && gWaterMap == false));
                  break;
               }
               case cCivRussians:
               {
                  exclude = ((tech == cTechHCXPMasterSurgeons) || (tech == cTechHCExplorerRussian) ||
                     ...
                     (tech == cTechHCXPAssassins) || (tech == cTechHCSilversmith) || (tech == cTechHCSpiceTrade) ||
                     (tech == cTechDEHCTheaters) || (tech == cTechHCBlockhouseCannon) ||
                     (tech == cTechHCShipSettlers2) || (tech == cTechHCFrontierDefenses2) ||
                     (tech == cTechHCEngineeringSchool) || //(tech == cTechHCDuelingSchoolTeam) || 
                     (tech == cTechHCMercenaryLoyalty) || (tech == cTechHCAdvancedTradingPost) ||
                     (tech == cTechHCAdmirality && gWaterMap == false));
                  break;
               }
               case cCivSpanish:
               {
                  exclude = ((tech == cTechHCExplorerSpanish) || (tech == cTechHCExplorerCombatTeam) ||
                     (tech == cTechHCShipBalloons) || (tech == cTechHCXPRanchingLlama) ||
                     (tech == cTechHCStockyards) || (tech == cTechHCNativeTreaties) || (tech == cTechHCMedicine) ||
                     (tech == cTechHCXPTercioTactics) || (tech == cTechHCSilversmith) || (tech == cTechHCSpiceTrade) ||
                     (tech == cTechDEHCTheaters) || (tech == cTechHCXPAssassins) ||
                     (tech == cTechHCHeavyFortifications) ||
                     (tech == cTechHCShipSettlers2) || (tech == cTechDEHCMarvelousYear) ||
               ...
               case cCivXPAztec:
               {
                  exclude = ((unit == cUnitTypePetJaguar) || (tech == cTechHCNativeTreaties) ||
                     //(tech == cTechHCXPWarChiefAztec1) || 
                     (tech == cTechHCXPShipJaguars3) ||
               ...
               case cCivXPIroquois:
               {
                  exclude = ((tech == cTechDEHCShipNativeScout) || (tech == cTechHCXPWarChiefIroquois1) ||
                     ...
                     //(tech == cTechHCXPKinshipTies) || 
                     (tech == cTechHCXPPioneers2) ||
               ...
               case cCivXPSioux:
               {
                  exclude = (//(tech == cTechHCXPWarChiefSioux1) || 
                  (tech == cTechDEHCShipNativeScout) ||
               ...
               case cCivChinese:
               {
                  exclude = ((tech == cTechYPHCShipDisciple1) || (tech == cTechYPHCRanchingWaterBuffalo) ||
                     ...
                     //(tech == cTechYPHCArtilleryHitpointsChinese) ||  
                     (tech == cTechYPHCConfusciousGift) ||  
               ...
               case cCivJapanese:
               {
                  exclude = ((tech == cTechYPHCShipMonitorLizard1) || (tech == cTechYPHCZenDiet) ||
                     (tech == cTechYPHCArmedFishermenJapanese) ||
               ...
               case cCivDESwedish:
               {
                  exclude = ((tech == cTechHCXPMasterSurgeons) || (tech == cTechDEHCExplorerSwedish) ||
                     (tech == cTechHCShipBalloons) || (tech == cTechHCXPRanching) ||
                     (tech == cTechDEHCOxenstiernaReforms) ||
                     (tech == cTechHCXPAssassins) || (tech == cTechHCSilversmith) || (tech == cTechHCSpiceTrade) ||
               ...
               case cCivDEAmericans:
               {
                  exclude = ((tech == cTechDEHCImmigrantsFrench) || (tech == cTechDEHCImmigrantsGerman) ||
                     ...
                     (tech == cTechDEHCFedGeneralAssembly) ||
                     ...
                     (tech == cTechDEHCShipHomesteadWagons1) || (tech == cTechHCAdmirality && gWaterMap == false));
                  break;
               }
               case cCivDEHausa:
               {
               ...
               case cCivDEMaltese:
               {
                  exclude = ((tech == cTechDEHCExplorerMaltese) || (tech == cTechHCShipBalloons) ||
                     ...
                     (tech == cTechDEHCTheaters) || (tech == cTechHCSilversmith) || (tech == cTechHCSpiceTrade) ||
               ...
               case cCivDEItalians:
               {
                  exclude = ((tech == cTechDEHCExplorerItalian) || (tech == cTechHCShipBalloons) ||
                     ...
                     (tech == cTechHCNativeTreaties) || (tech == cTechHCSilversmith) || (tech == cTechHCSpiceTrade) ||
                     ...
                     (tech == cTechDEHCUffizi) || (tech == cTechHCAdvancedTradingPost) ||
                     (tech == cTechHCAdmirality && gWaterMap == false));
                  break;
               }
            ...
            if (exclude == false)
            {
               ...
               if ((kbProtoUnitIsType(cMyID, unit, cUnitTypeHerdable) == true) ||
                   ...
                   (unit == cUnitTypexpSpy) || (unit == cUnitTypeTradingPostTravois) || (unit == cUnitTypeSettlerWagon) ||
                   (unit == cUnitTypedeSpyOttoman) || (unit == cUnitTypeCrossbowman) || (unit == cUnitTypeAbstractArtillery) ||
            ...
            if (exclude == false)
            {
               ...
               if (((startingResources == cGameStartingResourcesInfinite)) &&
                   ...
                   //((currentCardFlags & cHCCardFlagGatherRate) == cHCCardFlagGatherRate) || -- For testing...
         ...
         (tech == cTechHCXPCavalryCombatSioux) || (tech == cTechDEHCAkicita) || (tech == cTechHCXPFlorenceNightingale) ||
         (tech == cTechYPHCWesternReforms) || (tech == cTechHCInfantryCombatDutch) ||
         (tech == cTechHCCavalryCombatDutch) || (tech == cTechDEHCChewaWarriors) ||
         (tech == cTechYPHCShipBerryWagon2) || (tech == cTechYPHCForeignLogging) || (tech == cTechHCSustainableAgriculture) ||
         (tech == cTechYPHCCamelDamageIndians) || (tech == cTechYPHCEastIndiaCompany) ||
         (tech == cTechHCXPKnightCombat) || (tech == cTechHCXPCoyoteCombat) || (tech == cTechHCFullingMills) ||
         (tech == cTechDEHCCurare) || (tech == cTechDEHCRoadBuilding) ||          
         (tech == cTechHCXPTempleXolotl) || (tech == cTechHCCavalryCombatFrench) || (tech == cTechHCRefrigeration) ||
         (tech == cTechDEHCLongRifles) || (tech == cTechDEHCRollingArtillery) || (tech == cTechHCTextileMills) ||
			(tech == cTechHCRoyalDecreeSpanish) || (tech == cTechHCAdvancedArsenal) || (tech == cTechHCTextileMillsGerman) ||
			(tech == cTechHCRoyalDecreeBritish) || (tech == cTechDEHCBlueGuards) || (tech == cTechHCGermantownFarmers) ||
			(tech == cTechHCHeavyFortifications) || (tech == cTechHCRobberBarons) || (tech == cTechHCXPIndustrialRevolution)) && gWaterMap == false)  
         {
            cardPriority += 100;
         }

         // Section for civilizations that need more help in selecting their cards within the new system...
         // Aztec
         if ((cDifficultyCurrent >= cDifficultyHard) && cMyCiv == cCivXPAztec &&
             ((tech == cTechHCXPWarChiefAztec2) || (tech == cTechHCXPChinampa1) || (tech == cTechHCXPChinampa2) ||
              (tech == cTechHCGrainMarket) || (tech == cTechHCXPRuthlessness) || 
              (tech == cTechHCXPWarHutTraining) || (tech == cTechHCXPCoyoteCombat) || (tech == cTechHCXPTempleXipeTotec) ||
              (tech == cTechHCXPStoneTowers) || (tech == cTechHCXPReligiousUnity) || (tech == cTechHCXPWarChiefAztec1)))  
         {
            cardPriority += 100;
         }
         // British
         if ((cDifficultyCurrent >= cDifficultyHard) && cMyCiv == cCivBritish && 
             ((tech == cTechHCXPCherokeeAlliesRepeat))) {
            cardPriority += 100;
         }
         // Chinese
         ...
         // Dutch
         if ((cDifficultyCurrent >= cDifficultyHard) && cMyCiv == cCivDutch && 
             ((tech == cTechHCXPCaribAlliesRepeat))) {
            cardPriority += 100;
         }
         // Ethiopians
         if ((cDifficultyCurrent >= cDifficultyHard) && cMyCiv == cCivDEEthiopians &&
             ((tech == cTechDEHCTemenyas) || (tech == cTechDEHCShiftas) || (tech == cTechDEHCKingKings) ||
              (tech == cTechDEHCHegemony) || (tech == cTechDEHCFazogli) || 
              (tech == cTechDEHCFasilidesCastle) || (tech == cTechDEHCIyasuReforms) || (tech == cTechDEHCGondarineArchitecture) ||
              (tech == cTechDEHCJesuitSpirituality) || (tech == cTechDEHCBeekeepers) || (tech == cTechDEHCMassLeviesAfrican) ||
              (tech == cTechDEHCCartridgeCurrency) || (tech == cTechDEHCBalambaras) || 
              (tech == cTechDEHCHandInfantryCombatEthiopian) || (tech == cTechDEHCLalibelaRockChurch) ||
              (tech == cTechDEHCCoffeeConsumption) || (tech == cTechDEHCRoofAfrica) || (tech == cTechDEHCShewaRiders) ||
              (tech == cTechDEHCBigLevy)))  
         {
            cardPriority += 100;
         }
         // French
         if ((cDifficultyCurrent >= cDifficultyHard) && cMyCiv == cCivFrench && 
             ((tech == cTechHCXPHuronAlliesRepeat))) {
            cardPriority += 100;
         }
         // Germans
         if ((cDifficultyCurrent >= cDifficultyHard) && cMyCiv == cCivGermans && 
             ((tech == cTechDEHCHabsburgAllies2) || (tech == cTechHCSustainableAgricultureGerman))) {
            cardPriority += 100;
         }
         // Iroquois/Huadenosaunee
         if ((cDifficultyCurrent >= cDifficultyHard) && cMyCiv == cCivXPIroquois &&
             ((tech == cTechHCXPInfantryLOSTeam) || (tech == cTechDEHCShipCougarPelts) || (tech == cTechHCXPWarHutTraining) ||
              (tech == cTechHCXPWarHouses) || (tech == cTechDEHCNorthAmericaTrade) || 
              (tech == cTechDEHCEnvironmentalism) || (tech == cTechDEHCWampum) || (tech == cTechDEHCBeaverWars) ||
              (tech == cTechHCXPConservativeTactics) || (tech == cTechYPHCNativeDamage) || (tech == cTechYPHCNativeHitpoints)))  
         {
            cardPriority += 100;
         }
         // Huasa
         if ((cDifficultyCurrent >= cDifficultyHard) && cMyCiv == cCivDEHausa &&
             ((tech == cTechDEHCGidanSarkin) || (tech == cTechDEHCPalaceAmina) || (tech == cTechDEHCKoose) ||
              (tech == cTechDEHCIndigoDyeworks) || (tech == cTechDEHCFulaniPulaakuCode) || 
              (tech == cTechDEHCGobarauMinaret) || (tech == cTechDEHCDaneGuns) || (tech == cTechDEHCHandCavalryDamageHausa) ||
              (tech == cTechDEHCHandCavalryHitpointsHausa) || (tech == cTechDEHCFulaniArcherCombat) || (tech == cTechDEHCMassLeviesAfrican) ||
              (tech == cTechDEHCFulaniCattleFertilizer) || (tech == cTechDEHCCounterCavalry) || 
              (tech == cTechDEHCSahelianKingdoms) || (tech == cTechDEHCMaguzawa) ||
              (tech == cTechDEHCSuyaSkewers) || (tech == cTechDEHCDodoCult) || (tech == cTechDEHCKolaNutCultivation) ||
              (tech == cTechDEHCDurbarParade)))  
         {
            cardPriority += 100;
         }
         // Inca
         if ((cDifficultyCurrent >= cDifficultyHard) && cMyCiv == cCivDEInca &&
             ((tech == cTechDEHCWarChiefInca1) || (tech == cTechDEHCQuipuKamayuks) || (tech == cTechDEHCLlamaLifestyle) ||
              (tech == cTechDEHCCurare) || (tech == cTechDEHCSaltPonds) || 
              (tech == cTechDEHCTerraceFarming) || (tech == cTechDEHCRoadBuilding) || (tech == cTechDEHCIncaFortifications) ||
              (tech == cTechDEHCCloudFortresses) || (tech == cTechDEHCMeleeInfCombatInca) || (tech == cTechDEHCAutarky)))  
         {
            cardPriority += 100;
         }
         // India
         if ((cDifficultyCurrent >= cDifficultyHard) && cMyCiv == cCivIndians &&
             ((tech == cTechYPHCForeignLogging) || (tech == cTechYPHCCalltoArms1) || (tech == cTechYPHCAdvancedMonasteryIndians) ||
              (tech == cTechYPHCShipCastleWagons1) || (tech == cTechYPHCEastIndiaCompany) || 
              (tech == cTechYPHCElephantCombatIndians) || (tech == cTechYPHCRainbowTrickleIndians) || (tech == cTechYPHCElephantCombatIndians) ||
              (tech == cTechYPHCInfantryCombatIndians) || (tech == cTechYPHCCamelDamageIndians) || (tech == cTechYPHCCamelFrightening)))  
         {
            cardPriority += 100;
         }
         // Italians
         if ((cDifficultyCurrent >= cDifficultyHard) && cMyCiv == cCivDEItalians &&
             ((tech == cTechDEHCUsury) || (tech == cTechDEHCRoyalDecreeItalians) || (tech == cTechDEHCSchiavoniSwords) ||
              (tech == cTechDEHCFreemasonry) || (tech == cTechDEHCAlpini) || 
              (tech == cTechDEHCUffizi) || (tech == cTechDEHCRedshirts) || (tech == cTechDEHCAdvancedLombard) ||
              (tech == cTechDEHCMilaneseArsenal)))  
         {
            cardPriority += 100;
         }
         // Japanese
         if ((cDifficultyCurrent >= cDifficultyHard) && cMyCiv == cCivJapanese &&
             ((tech == cTechYPHCShrineLearning) || (tech == cTechYPHCBerryGrove) || (tech == cTechYPHCIncreasedTribute) ||
              (tech == cTechYPHCJapaneseSiege) || (tech == cTechYPHCAshigaruAntiCavalryDamage) || 
              (tech == cTechYPHCSamuraiSpeed) || (tech == cTechYPHCBakufu) || (tech == cTechYPHCShipDaimyoAizu) ||
              (tech == cTechYPHCShipShogunate) || (tech == cTechYPHCStoneCastles) || (tech == cTechYPHCNaginataHitpoints) ||
              (tech == cTechYPHCAshigaruDamage) || (tech == cTechYPHCYumiRange) || 
              (tech == cTechYPHCYumiDamage) || (tech == cTechYPHCSamuraiDamage) ||
              (tech == cTechYPHCYabusameDamage) || (tech == cTechYPHCYabusameAntiArtilleryDamage) || 
              (tech == cTechYPHCArtilleryCostJapanese) || (tech == cTechYPHCShipCastleWagons1)))  
         {
            cardPriority += 100;
         }
         // Maltese
         if ((cDifficultyCurrent >= cDifficultyHard) && cMyCiv == cCivDEMaltese &&
             ((tech == cTechDEHCGermanTongue) || (tech == cTechDEHCPapalDecreeDissolveTemplars) || (tech == cTechDEHCFlameThrowers) ||
              (tech == cTechDEHCSicilianSupply) || (tech == cTechDEHCFlintlockRockets) || 
              (tech == cTechDEHCDignitaries) || (tech == cTechDEHCRocketThrowers) || (tech == cTechDEHCMalteseCombat) ||
              (tech == cTechDEHCEarlyFort) || (tech == cTechDEHCSquires) || (tech == cTechDEHCRussianTongue) ||
              (tech == cTechDEHCBritishTongue) || (tech == cTechDEHCPortugueseTongue) || (tech == cTechDEHCSpanishTongue)))  
         {
            cardPriority += 100;
         }
         // Mexicans
         if ((cDifficultyCurrent >= cDifficultyHard) && cMyCiv == cCivDEMexicans &&
             ((tech == cTechDEHCGeneralMexicans) || (tech == cTechDEHCJalapenoPeppers) || (tech == cTechDEHCMachetes) ||
              (tech == cTechDEHCRoyalDecreeMexican) || (tech == cTechDEHCPresidios) || 
              (tech == cTechDEHCGuerillaTactics) || (tech == cTechDEHCReservistas) || (tech == cTechDEHCPresidialLancers) ||
              (tech == cTechDEHCPorfiriato)))  
         {
            cardPriority += 100;
         }
         // Ottomans
         if ((cDifficultyCurrent >= cDifficultyHard) && cMyCiv == cCivOttomans && 
             ((tech == cTechHCShipSpahis2))) {
            cardPriority += 100;
         }
         // Portuguese
         if ((cDifficultyCurrent >= cDifficultyHard) && cMyCiv == cCivPortuguese && 
             ((tech == cTechHCXPTupiAlliesRepeat))) {
            cardPriority += 100;
         }
         // Sioux/Lakota
         if ((cDifficultyCurrent >= cDifficultyHard) && cMyCiv == cCivXPSioux &&
             ((tech == cTechHCXPGreatHunter) || (tech == cTechHCXPOnikare) || (tech == cTechHCXPWarChiefSioux1) ||
              (tech == cTechHCXPWarChiefSioux2) || (tech == cTechDEHCNorthAmericaTrade) || 
              (tech == cTechHCXPBlackArrow) || (tech == cTechHCXPMustangs) || (tech == cTechHCXPMorningStar) ||
              (tech == cTechHCXPNomadicExpansion) || (tech == cTechHCXPEarthBounty) || (tech == cTechHCXPFriendlyTerritory)))  
         {
            cardPriority += 100;
         }
         // Spanish
         if ((cDifficultyCurrent >= cDifficultyHard) && cMyCiv == cCivSpanish && 
             ((tech == cTechHCXPMayanAlliesRepeat))) {
            cardPriority += 100;
         }
         // Swedish
         if ((cDifficultyCurrent >= cDifficultyHard) && cMyCiv == cCivDESwedish && 
             ((tech == cTechDEHCWittelsbachAlliesRepeat))) {
            cardPriority += 100;
         }
         // Russians
         if ((cDifficultyCurrent >= cDifficultyHard) && cMyCiv == cCivRussians && 
             ((tech == cTechDEHCOldenburgAlliesRepeat))) {
            cardPriority += 100;
         }
         // Americans
         if ((cDifficultyCurrent >= cDifficultyHard) && cMyCiv == cCivDEAmericans &&
             ((tech == cTechDEHCImmigrantsDutch) || (tech == cTechDEHCLongRifles) || (tech == cTechDEHCContinentalRangers) ||
              (tech == cTechDEHCBuffaloSoldiers) || (tech == cTechDEHCUSMarines) || 
              (tech == cTechDEHCGeneralAmericans) || (tech == cTechDEHCREVCTrainTimeUS) || (tech == cTechDEHCMinneapolisMills) ||
              (tech == cTechDEHCKosciuszkoFortifications)))  
         {
            cardPriority += 100;
         }
			
			// Prioritize water cards on water maps...
			if (tech == cTechDEHCShipBattleshipRepeat && gWaterMap == true){
				cardPriority += 100;
			}
			if ((tech == cTechDEHCShipNuestrasSenoras && gWaterMap == true) || (tech == cTechDEHCRuleBritannia && gWaterMap == true) ||
			(tech == cTechDEHCDutchBattleshipCard && gWaterMap == true) || (tech == cTechDEHCFrenchBattleshipCard && gWaterMap == true) ||
			(tech == cTechDEHCGermanBattleshipCard && gWaterMap == true) || (tech == cTechDEHCItalianBattleshipCard && gWaterMap == true) ||
			(tech == cTechDEHCOttomanBattleshipCard && gWaterMap == true) || (tech == cTechDEHCPortugueseBattleshipCard && gWaterMap == true) ||
			(tech == cTechDEHCShipBalticFleet && gWaterMap == true) || (tech == cTechDEHCRussianBattleshipCard && gWaterMap == true) ||
			(tech == cTechHCArmada && gWaterMap == true) || (tech == cTechHCShipGalleons && gWaterMap == true) || 
         (tech == cTechHCAdmirality && gWaterMap == true) || (tech == cTechHCAdmiralityGerman && gWaterMap == true) ||
         (tech == cTechYPHCAdmiralityIndians && gWaterMap == true) || (tech == cTechHCNavalCombat && gWaterMap == true) || 
         (tech == cTechHCRobberBarons) || (tech == cTechHCXPIndustrialRevolution) || (tech == cTechHCGermantownFarmers) ||
         (tech == cTechHCShipSpahis4)){
				cardPriority += 100;
			}
            ...
            if ((cDifficultyCurrent >= cDifficultyModerate) &&
               ...
               (tech == cTechDEHCChiribayaDogs) || (tech == cTechDEHCLandwehr) ||          
               (tech == cTechHCXPGreatTempleHuitzilopochtli) || (tech == cTechHCMusketeerGrenadierHitpointsBritishTeam) || 
               (tech == cTechHCCavalryHitpointsBritish) || //(tech == cTechDEHCRangers) || - We can get this at the church...
            ...
            if ((cDifficultyCurrent >= cDifficultyModerate) &&
                ((tech == cTechHCXPAztecMining) || (tech == cTechDEHCChichimecaRebellion) || 
                 ...
                 (tech == cTechHCCaballeros) || //(tech == cTechHCSpiceTrade) ||
				 ...
				 (tech == cTechDEHCVasaAllies1) ||
				 (tech == cTechYPHCNavalCombatIndians)))
            {
               cardPriority += 1+aiRandInt(4); //(tech == cTechDEHCShipBattleshipRepeat) || - Was removed from here...
            }
            ...
            if ((cDifficultyCurrent >= cDifficultyModerate) &&
                ((tech == cTechHCXPBloodBrothers) ||
                (tech == cTechDEHCHandMortar) || 
				...
				(tech == cTechHCGuildArtisans) || (tech == cTechDEHCPolk)))
            {
               cardPriority -= 2;
            }
            ...
            if ((cDifficultyCurrent >= cDifficultyModerate) &&
				  ...
				  (tech == cTechDEHCLandedGentry) || (tech == cTechDEHCMercWaardgelders) ||
          (tech == cTechDEHCSPCInsurgenteCombat) ||
				  (tech == cTechDEHCShipPikemenBritish) || (tech == cTechDEHCBashkirRebellion)))
         ...
         // Settings for average games in case any cards were missed.
         if (cDifficultyCurrent >= cDifficultyHard) {
            if (((currentCardFlags & cHCCardFlagUnitUpgrade) == cHCCardFlagUnitUpgrade) || (currentCardFlags == 0)) {
               cardPriority += 100;
            }
            else if (((currentCardFlags & cHCCardFlagGatherRate) == cHCCardFlagGatherRate)) {
               cardPriority += 100;
            }
            else if (((currentCardFlags & cHCCardFlagResourceCrate) == cHCCardFlagResourceCrate || 
                     (currentCardFlags & cHCCardFlagUnit) == cHCCardFlagUnit ||
                     (currentCardFlags & cHCCardFlagMilitary) == cHCCardFlagMilitary) && (cardAgePreReq < cAge4)) {
               cardPriority = 0;
            }
         }

         // We don't need resource gathering if we have infinite resources.
         if ((startingResources == cGameStartingResourcesInfinite) &&
         (currentCardFlags & cHCCardFlagUnit) == cHCCardFlagUnit && (cardAgePreReq == cAge4)) {
            cardPriority += 100;
         } else if ((startingResources == cGameStartingResourcesInfinite) &&
      ...
      default: // Make deck.
      {
         ...
         switch (pass)
         {
            ...
            case 1:
            {
               if (toPick < 0) // How many cards can we pick this case.
               {
				  ...
				  else if (cMyCiv == cCivChinese || cMyCiv == cCivIndians) {
					 toPick = 6; //
				  }
                  else
                  {
               ...
               if (toPick > 0)
               {
                  for (card = 0; < totalCardCount) // Parse all cards.
                  {
                     ...
                     if (((cMyCiv == cCivIndians) && (tech == cTechYPHCAgrarianism)) || // Indian starting wood trickle.
						 ...
						 ((cMyCiv == cCivSpanish) && (tech == cTechHCXPUnction)))
            ...
            case 2:
            {
               if (toPick < 0)
               {
                  ...
                  else if (aiTreatyGetEnd() <= 0) // Non-treaty game
                  {
                     toPick = 2; // 1 Resource crate in the Commerce Age.
                  }
                  else
                  {
                     //toPick = 0; // Treaty game, skip crates.
                  }
                  if (btRushBoom > 0.0)
                  {
            ...
            case 3:
            {
               ...
               {
                  if (aiTreatyGetEnd() > 21 * 60 * 1000) // Long treaty game, we don't add military in Commerce so fill here.
                  {
                  ...
                  {
                     // Consolidated civ-specific toPick assignments
                     if (cMyCiv == cCivDESwedish || cMyCiv == cCivIndians || cMyCiv == cCivJapanese || cMyCiv == cCivChinese)
                     {
                        toPick = 10;
                     }
                     ...
                     else if ((cMyCiv == cCivDEHausa) || (cMyCiv == cCivDutch) || (cMyCiv == cCivDEMexicans))
                     {
                        toPick = 5;
                     }
                     else
                     ...
                     if ((startingResources == cGameStartingResourcesInfinite) ||
                        (startingResources == cGameStartingResourcesUltra))
                     {
                        if ((cMyCiv == cCivDutch) && (startingResources == cGameStartingResourcesInfinite))
                        {
                           toPick += 2; // Add the Bank card replacements here.
                        }
                        else if ((cMyCiv == cCivDESwedish) && (startingResources == cGameStartingResourcesInfinite))
                        {
                           toPick += 1; // Add the Blueberries card replacement here.
                        }
                        toPick += 3;
                        if (btRushBoom > 0.0)
                        {
                           ...
                           (tech == cTechHCAdvancedArsenalGerman) || (tech == cTechDEHCSpringfieldArmory)))
                     {
                        if (xsArrayGetInt(cardPriorities, card) > bestCardPriority)
                        {
                           ...
                           bestCard = card;
				  				  ...
				  				  // Add fortifications...
				  //if (tech == cTechYPHCExtensiveFortifications){
						//bestCard = card;
                        //break;
				  //}
				  
				  // Fortifications...
				  if (tech == cTechYPHCExtensiveFortifications || tech == cTechDEHCExtensiveFortificationsEuropean){
				  	bestCard = card;
                    //break;
					xsArraySetInt(cardStates, bestCard, cCardStateInDeck);
				  }
            ...
            case 4:
            {
               static bool pickedCommerceCostUnit = true; // Prevent multiple units with a cost being added (we don't reserve resources for this).
               static bool addedVillager = true;
               if (toPick < 0)
               {
                  if (aiTreatyGetEnd() > 21 * 60 * 1000) // Long treaty game, don't add military in Commerce.
                  {
                     if ((startingResources == cGameStartingResourcesInfinite) ||
                         (startingResources == cGameStartingResourcesUltra) ||
                         (age >= cAge4) ||
            ...
            case 5:
            {
               if (toPick < 0)
               {
                  ...
                  {
                     //toPick = 0; // 1 Resource crate in the Fortress Age.
                  }
                  else
                  {
                     //toPick = 0; // Treaty game, skip crates.
            ...
            case 6:
            {
               ...
               {
                  // Consolidated civ-specific toPick assignments
                  if (cMyCiv == cCivChinese || cMyCiv == cCivIndians)
                  {
                     toPick = 9;
                  }
                  else if (cMyCiv == cCivOttomans || cMyCiv == cCivDESwedish)
                  {
                     toPick = 8;
                  }
                  else if (cMyCiv == cCivBritish || cMyCiv == cCivGermans || cMyCiv == cCivJapanese || 
                           cMyCiv == cCivDEInca || cMyCiv == cCivXPSioux)
                  {
                     toPick = 6;
                  }
                  else if ((cMyCiv == cCivDEMexicans) || (cMyCiv == cCivDEAmericans) || (cMyCiv == cCivPortuguese))
                  {
                     toPick = 4;
                  }
                  else
               ...
               if (toPick > 0)
               {
				  ...
				  if (((currentCardFlags & cHCCardFlagGatherRate) == cHCCardFlagGatherRate)){
						xsArraySetInt(cardStates, bestCard, cCardStateInDeck);
                        cardsRemaining--;
                        cardsPicked++;
                        cardsInAge3++;
            ...
            {
               // if (unit == cUnitTypeFortWagon){
               //    toPick = 2; // Added to prevent the AI from selecting useless unit cards...
               // } else {
               //    toPick = 1;
               // }
               toPick = 1;
               static bool pickedFortressCostUnit = true; // Prevent multiple units with a cost being added (we don't reserve resources for this).
               static bool pickedFortress = false;
               if (toPick < 0)
               {
               ...
               if (toPick > 0)
               {
                  ...
                  for (card = 0; < totalCardCount)
                  {
                     ...
                     // This card seems to be miscategorized. It should be in the upgrades section.
                     if ((kbGetTechName((aiHCCardsGetCardTechID(card))) == "DEHCLandwehr") && cMyCiv == cCivGermans)
                     {
                        bestCard = card;
                        addCardToDeck(gDefaultDeck, bestCard);
                     }
                     // We want Blue Guards!
                     if ((kbGetTechName((aiHCCardsGetCardTechID(card))) == "DEHCBlueGuards") && cMyCiv == cCivDutch)
                     {
                        bestCard = card;
                        addCardToDeck(gDefaultDeck, bestCard);
                     }

                     if (kbGetTechName((aiHCCardsGetCardTechID(card))) == "HCGermantownFarmers"){
                        bestCard = card;
                        addCardToDeck(gDefaultDeck, bestCard);
                     }
                         ...
                         (aiHCCardsGetCardCount(card) > 0))
                     {
						...
						//if (unit == cUnitTypeMusketeer && cMyCiv == cCivDutch) // Always get the Blue Guard Musketeers.
                        //{
                           //totalValueCurrent = 10000.0;
                        //}   
                  ...
                  if (bestCard >= 0 && unit == cUnitTypeFortWagon)
                  {
                     if (addCardToDeck(gDefaultDeck, bestCard) == true)
                     {
                        if (unitHasACost == true)
            ...
            case 10:
            {
               ...
               // We should get extra ones if we have infinite resources. Enhanced
               if ((startingResources == cGameStartingResourcesInfinite)) {
                  toPick = 5;
               }
            ...
            case 11:
            {
			   ...
			   if (gWaterMap == true){
					 //toPick = 5;
				  toPickNaval = 2; // We definitely need some naval cards...!
			   } else {
					//toPick = 4;
			   }
                  if (isTeamGame == true)
               ...
               if ((toPick == 0 || toPick < 0) && cMyCiv == cCivOttomans) {
                  toPick = 1;
               }
               ...
               if (toPick > 0)
               {
                  ...
                  for (card = 0; < totalCardCount)
                  {
					//if (unit == cUnitTypeAbstractArtillery || unit == cUnitTypeAbstractInfantry ||
					    //unit == cUnitTypeAbstractCavalry){
						//toPick--;
						//toPickNaval--;
						//break;
					//}
					...
					//}
					 ...
					 //if (card == DEHCShipBattleshipRepeat && gWaterMap == true){
                     ...
                     if (unit == cUnitTypeFactoryWagon && civIsEuropean() == true)
                     {
                        ...
                        toPickNaval++;
                        break;
                     } else if (civIsEuropean() == false) {
                        hasBothFactories = true;
                        factoryCount = 2;
                     }          
					 
					 if ((unit == cUnitTypedeMercBattleship && gWaterMap == true) && hasBattleShip == false){
						bestCard = card;
                  hasBattleShip = true;
						break;
					 }
					 
					 // Always get the Fort cards...
					 if (unit == cUnitTypeFortWagon && hasIndustrialFort == false)
                     {
                        bestCard = card;
                        hasIndustrialFort = true;
                        //pickedFortress = true;
                        //toPickNaval++;
                        break;
                     }
                  ...
                  if ((bestCard >= 0 && ((unit == cUnitTypeFactoryWagon || unit == cUnitTypeFortWagon)
						|| (gWaterMap == true && unit == cUnitTypedeMercBattleship)) && civIsEuropean() == true) ||
                  (bestCard >= 0 && civIsEuropean() == false && (unit != cUnitTypeAbstractArtillery && unit != cUnitTypeAbstractInfantry &&
					    unit != cUnitTypeAbstractCavalry && unit != cUnitTypeAbstractWarShip)))
                  {
                     if (addCardToDeck(gDefaultDeck, bestCard) == true)
                     {
                        if (unitHasACost == true)
            ...
            case 12:
            {
               ...
               tryCounter++;
               if (cardsRemaining == 0 && factoryCount >= 1)
               {
                  pass = 13; // Yeey we're done!
               }
               else if ((cardsRemaining > 0) && (tryCounter > 10))
               {
                  ...
                  int emptyCardSlots = aiHCDeckGetNumberCards(gDefaultDeck);
                  emptyCardSlots = 25 - emptyCardSlots;
                  cardsRemaining = emptyCardSlots;
               if (civIsEuropean() == true && cardsRemaining > 0) {
                  pass = aiRandInt(11);
               }
               break;
               // if (hasBothFactories == true) {
               //    static int tryCounter = 0; // If this goes too high we just opt out and prevent an infinite loop.
               // static bool hasOptedOut = false;
               // if (tryCounter == 0)
               // {
               ...
               // }
               // unit = xsArrayGetInt(unitCardShippedUnit, card);
               // if ((cardsRemaining > 0) && (hasOptedOut == false) && (unit != cUnitTypeAbstractArtillery && unit != cUnitTypeAbstractInfantry &&
					//     unit != cUnitTypeAbstractCavalry && unit != cUnitTypeAbstractWarShip))
               // {
               //    bestCard = -1;
               //    bestCardPriority = -1;
         ...
         //    aiHCDeckAddCardToDeck(gDefaultDeck, int cardIndex = -1  );
         // }

         if (pass >= 13 && factoryCount >= 1)
         {
            debugHCCards("Activating deck");
...
void shipGrantedHandler(int parm = -1) // parm is unused.
{
   ...
   for (deckIndex = 0; < 2)
   {
      ...
      for (i = 0; < totalCards)
      {
         ...
         switch (unitType)
         {
			...
			case gBattleShipUnit:
            {
               if ((gBattleshipMaintain >= 0) &&
                   (aiPlanGetVariableInt(gBattleshipMaintain, cTrainPlanNumberToMaintain, 0) >
                    kbUnitCount(cMyID, gBattleShipUnit, cUnitStateABQ)))
               {
                  totalValue = getUnitCardNetValue(deck, i , tech);
               }
               break;
            ...
            default: 
            {
               ...
               // Handle 'German Town Farmers and Guild Artisans' (Germans)
            if ((kbGetTechName(aiHCDeckGetCardTechID(gDefaultDeck, i)) == "HCGermanTownFarmers") ||
			(kbGetTechName(aiHCDeckGetCardTechID(gDefaultDeck, i)) == "HCGuildArtisans"))
            {
               if ((getUnit(cUnitTypeAbstractVillager, cMyID, cUnitStateAlive) <= 30) || (kbGetAge() < cAge4))
               {
                  totalValue = 2500.0;
                  if (kbGetCiv() == cCivGermans)
                     totalValue = 8800.0; // Necessary to cope with uhlans being included in calculation
			  }
               ...
               else
               {
                  totalValue = 5000.0;
                  if (kbGetCiv() == cCivGermans)
                     totalValue = 10000.0; // Necessary to cope with uhlans being included in calculation
			  }
            }						

			  
            // Handle 'Refrigeration/Royal Mint' (European, Chinese, Japanese and Indian)
            if ((kbGetTechName(aiHCDeckGetCardTechID(gDefaultDeck, i)) == "HCRefrigeration") ||
            (kbGetTechName(aiHCDeckGetCardTechID(gDefaultDeck, i)) == "HCRefrigerationGerman") ||
            (kbGetTechName(aiHCDeckGetCardTechID(gDefaultDeck, i)) == "HCRoyalMint") ||
			(kbGetTechName(aiHCDeckGetCardTechID(gDefaultDeck, i)) == "HCRoyalMintGerman"))
            {
               if ((getUnit(cUnitTypeAbstractVillager, cMyID, cUnitStateAlive) <= 30) || (kbGetAge() < cAge4))
               {
                  totalValue = 1950.0;
                  if (kbGetCiv() == cCivGermans)
                     totalValue = 7000.0; // Necessary to cope with uhlans being included in calculation
			  }
               ...
               else
               {
                  totalValue = 3000.0;
                  if (kbGetCiv() == cCivGermans)
                     totalValue = 7800.0; // Necessary to cope with uhlans being included in calculation
			  }
            }						

            // Handle 'Royal Mint' (Indian)
            ...
            // Handle 'Textile Mills' (European, Chinese and Japanese)
            if ((kbGetTechName(aiHCDeckGetCardTechID(gDefaultDeck, i)) == "HCTextileMills") ||
			(kbGetTechName(aiHCDeckGetCardTechID(gDefaultDeck, i)) == "HCTextileMillsGerman"))
            {
               if ((getUnit(cUnitTypeAbstractVillager, cMyID, cUnitStateAlive) <= 30) || (kbGetAge() < cAge4))
               {
                  totalValue = 1700.0;
                  if (kbGetCiv() == cCivGermans)
                     totalValue = 5000.0; // Necessary to cope with uhlans being included in calculation
			  }
               else
               {
                  totalValue = 2800.0;
                  if (kbGetCiv() == cCivGermans)
                     totalValue = 6500.0; // Necessary to cope with uhlans being included in calculation
			  }
            }
   ...
   if (bestCard >= 0)
   {
      ...
      if (cDifficultyCurrent >= cDifficultyHard) // Enhanced - was cDifficultyExpert
      {
         int gatherUnitID = -1;
